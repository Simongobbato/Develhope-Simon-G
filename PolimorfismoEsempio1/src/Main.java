...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("prezzo finale(con IVA): " +carrelloSenzaIVA.getPrezzoFinale(true));
        System.out.println("prezzo finale(senza IVA): " + carrelloSenzaIVA.getPrezzoFinale(false));
        ...
        System.out.println("prezzo finale(con IVA): " + carrelloConIVA.getPrezzoFinale(true));
        System.out.println("prezzo finale(senza IVA): " + carrelloConIVA.getPrezzoFinale(false));
    }
}